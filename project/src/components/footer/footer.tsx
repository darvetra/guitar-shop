        ...
        <div className="socials footer__socials">
          <ul className="socials__list">
            <li className="socials-item">
              <Link to="#" className="socials__link" href="https://www.skype.com/" aria-label="skype">
            ...
            <li className="socials-item">
              <Link to="#" className="socials__link" href="https://www.vsco.com/" aria-label="vsco">
                <svg className="socials__icon" width="24" height="24" aria-hidden="true">
            ...
            <li className="socials-item">
              <Link to="#" className="socials__link" href="https://www.pinterest.com/" aria-label="pinterest">
                <svg className="socials__icon" width="24" height="24" aria-hidden="true">
        ...
        <section className="footer__nav-section footer__nav-section--links">
          ...
          <ul className="footer__nav-list">
            <li className="footer__nav-list-item">
              <Link className="link" to="#top">Где купить?</Link>
            </li>
            <li className="footer__nav-list-item">
              <Link className="link" to="#top">Блог</Link>
            </li>
            <li className="footer__nav-list-item">
              <Link className="link" to="#top">Вопрос - ответ</Link>
            </li>
            <li className="footer__nav-list-item">
              <Link className="link" to="#top">Возврат</Link>
            </li>
            <li className="footer__nav-list-item">
              <Link className="link" to="#top">Сервис-центры</Link>
            </li>
          </ul>
        </section>
